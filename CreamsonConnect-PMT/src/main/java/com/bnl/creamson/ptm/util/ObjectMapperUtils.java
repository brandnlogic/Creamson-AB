package com.bnl.creamson.ptm.util;
...
public class ObjectMapperUtils {
	...
	public static <D extends Object, T> List<D> mapAll(final Collection<T> entityList, Class<D> outCLass) {
		return (List<D>) entityList.stream().map(entity -> map(entity, outCLass)).collect(Collectors.toList());
	}
